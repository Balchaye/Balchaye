...
<div class="main">
  ...
  <div class="content">
    ...
    <p><a href="#"><strong></strong></a> <span></span> <span></span> <a href="#"><strong></strong></a></p>
        ...
        <div class="article">
         <h2><span>Achievements of KDA</span></h2> 
          <div class="clr"></div>
  ...
  if (isset($_POST['ProjectCode'])){
   mysql_select_db("kda",$con);
        $result=mysql_query("select * from  achievementable where ProjectCode = '$_POST[ProjectCode]'");
...
mysql_select_db("kda",$con);
$result=mysql_query("select *FROM  achievementable ");
...
echo"</tr>";
echo "<tr>"; 
echo"<td>"."<form class='form-horizontal' method='POST' enctype='multipart/form-data'>"."View More About The Project:-"." "."<input type='submit' name='ProjectCode' value='$row[ProjectCode]''/>"."<font size=3.5>"."<strong>"."</strong>" ."</font>"."</form>"."</td>";
echo"</tr>";
echo"</table>";
echo"<p>";
  echo"</p>";
